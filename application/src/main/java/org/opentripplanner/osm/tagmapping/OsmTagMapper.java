...
public class OsmTagMapper {
  ...
  public void populateProperties(WayPropertySet props) {
    ...
    props.setProperties(
      "highway=pedestrian",
      withModes(PEDESTRIAN).walkSafety(0.7).bicycleSafety(0.9)
    );
    props.setProperties(
      "highway=footway",
    ...
    /* cycleway=lane */
    props.setMixinProperties("cycleway=lane", ofBicycleSafety(0.87).addPermission(BICYCLE));

    /* cycleway=share_busway */
    props.setMixinProperties("cycleway=share_busway", ofBicycleSafety(0.92).addPermission(BICYCLE));
    ...
    /* cycleway=track */
    props.setMixinProperties("cycleway=track", ofBicycleSafety(0.75).addPermission(BICYCLE));
    ...
    props.setMixinProperties("cycleway=shared_lane", ofBicycleSafety(0.77).addPermission(BICYCLE));
