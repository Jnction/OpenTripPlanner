...
class PortlandMapper extends OsmTagMapper {
  ...
  public void populateProperties(WayPropertySet props) {
    props.setMixinProperties("highway=footway", ofWalkSafety(1 / 0.6));
    ...
    props.setMixinProperties("sidewalk=left", ofWalkSafety(0.9 / 0.8));
    props.setMixinProperties("sidewalk=right", ofWalkSafety(0.9 / 0.8));
